...
# Check for Z3 >= 4.8.11 (improved integer optimization and timeout handling)
req = 4.8.11
ifneq ($(shell (v=$$(ocamlfind query -format "%v" z3) ; echo $$v ; echo $(req)) | sort -V | head -n 1), $(req))
  $(error Check for z3 version >= $(req) failed.  $(REQERR))
endif
